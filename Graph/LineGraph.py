...
MainDatabase = pd.read_excel(r'../Database/LentilRawData.xlsx')
...
nineteen=MainDatabase.iloc[365:730]
# print(eighteen)
# print(nineteen)
...
#
# twentyrealdata=pd.read_excel(r'../Database/FinalDatabase.xlsx').iloc[760:]
#
# RealPrice=[]
...
# axes.set_yticks([65, 70, 75, 80, 85, 90, 95, 100, 105, 110,115,120,125,130,135,140])
